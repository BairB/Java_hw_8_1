...
class RadioTest {
    ...
    public void showStationWhenClickNext() {
        Radio radio = new Radio(11, 10, 0, 4 ,100, 0);
        int actual = (int) radio.findCurrentStation(11);
    ...
    public void showStationWhenClickPrev() {
        Radio radio = new Radio(-1, 10, 0, 4 ,100, 0);
        //int station = -1;
        int actual = (int) radio.findCurrentStation(-1);
    ...
    public void shouldNotChangeVolumeWhenPressPlus() {
        Radio radio = new Radio(4, 10, 0, 101 ,100, 0);
        assertEquals(100, radio.findVolume(radio.setVolume(101)));
    }

    @Test
    public void shouldNotChangeVolumeWhenPressMinus() {
        Radio radio = new Radio(4, 10, 0, -1 ,100, 0);
